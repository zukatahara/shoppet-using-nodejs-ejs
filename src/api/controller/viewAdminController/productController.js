...
class ProductController {
  ...
  getHomePage = async (req, res, next) => {
    ...
    // console.log(result)
    res.render("admin/managerProduct/index", { result: result });
    // res.send(result)
  };
  // render addUserPage
  addProductPage = async (req, res, next) => {
    ...
    await res.render("admin/managerProduct/add-product", { result });
  };
  //handle add product
  ...
  updateProductPage = async (req, res, next) => {
    ...
    // console.log(result)
    // res.send(result)
    await res.render("admin/managerProduct/add-product", { result: result });
  };
